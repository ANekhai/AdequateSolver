...
public class Detector {
    ...
    public boolean isValid(String node) { return valid.get(node); }
    ...
    public void updateValidVertices(String... vertices) {
        for (String vertex : vertices) {
            valid.put(vertex, false);
        }
    }
    ...
    //TODO: Rewrite using new subdetector classes, need to add
